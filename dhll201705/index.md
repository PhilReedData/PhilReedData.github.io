...
During the afternoon workshop, you will look at digital text collections from publishers on platforms such as JSTOR, John Rylands Library and Gale Cengage, using light-touch text and data mining techniques. Some of the activities may involve using a bit of Python code; however, the workshop assumes you may have no prior programming experience.  Computers will be available for all participants, but you may prefer to bring your own laptop.
...
- [Activity: Woodcut printing with John Rylands Research Institute](#)
- [Activity: Following up references with JSTOR Text Analyzer](#)
- [Activity: Dominant colour with Gale Cengage Illustrated London Historical Archive](#)
